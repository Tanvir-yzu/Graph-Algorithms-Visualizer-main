...
public class MainFrame extends JFrame {
    ...
    protected static final Color BACKGROUND_COLOR = Color.DARK_GRAY;
    ...
    private void setJMenu() {
        ...
        styleMenu(fileMenu);  // Apply style to the "File" menu
        menuBar.add(fileMenu);

        // Creating the menu "Mode"
        JMenu modeMenu = new JMenu("Mode");
        styleMenu(modeMenu);  // Apply style to the "Mode" menu
        menuBar.add(modeMenu);

        // Creating the menu "Algorithms"
        JMenu algorithmsMenu = new JMenu("Algorithms");
        styleMenu(algorithmsMenu);  // Apply style to the "Algorithms" menu
        ...
        // Style menu items
        styleMenuItem(addAVertex);
        styleMenuItem(addAnEdge);
        styleMenuItem(none);
        styleMenuItem(removeAVertex);
        styleMenuItem(removeAnEdge);
    ...
    private void setModeJLabel() {
        ...
        styleLabel(modeLabel);  // Apply style to the mode label
